...
def check_code(email_user, code, basket_id):
    ...
    query_delete = "DELETE FROM basket_basket_securitys WHERE basket_id="+basket_id+";"
    ...
    try:
        ...
        if thread_id is not None:
            query = "INSERT INTO basket_basket_securitys (basket_id, thread_id) VALUES ('"+basket_id+"', '"+thread_id+"')"
