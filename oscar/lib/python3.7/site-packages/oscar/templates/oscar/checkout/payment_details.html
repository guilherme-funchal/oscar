...
{% block payment_details %}
    {% block payment_details_content %}
        {% comment %} <p>{% trans "This page needs implementing within your project.  You may want to use one of Oscar's payment gateway libraries:" %}</p>
        <ul>
        ...
        <div class="form-actions">
    		...
    		{% endif %}
    			...
    			{% comment %} <a href="{% url 'checkout:index' %}" class="pull-right btn btn-large btn-primary">{% trans "Proceed to checkout" %}</a> {% endcomment %}
        </div>
