        ...
        {% block vouchers %}
            ...
            {% if voucher_form %}
                <div class="col-sm-6">
                    ...
                    <p id="voucher_form_link"><a href="#voucher" class="btn btn-secondary btn-full">{% trans "have a voucher code..." %}</a></p>
        ...
        {% comment %} <div class="form-actions">
            {% if anon_checkout_allowed or request.user.is_authenticated %}
                {% if basket.total_excl_tax > 0 %}
                    <a href="{% url 'paypal-redirect' %}"><img src="http://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif" align="left" style="margin-right:7px;"></a>
                {% endif %}
            {% endif %}
