...
class AccountAuthView(RegisterUserMixin, generic.TemplateView):
    ...
    def validate_registration_form(self):
        ...
        if form.is_valid():
            ...
            #Create user in badgr-server
            create_badge_user(form.cleaned_data['email'], form.cleaned_data['first_name'], form.cleaned_data['last_name'], form.cleaned_data['password1'])
